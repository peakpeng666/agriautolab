...
def main() -> None:
    ...
    parser.add_argument("--protocol", type=Path, default=ROOT / "evidence" / "block_d" / "selection_protocol_v1.json")
    parser.add_argument("--output", type=Path, default=ROOT / "evidence" / "block_d" / "h1_result.json")
